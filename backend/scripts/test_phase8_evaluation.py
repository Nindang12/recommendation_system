...
async def main() -> int:
    ...
    # Optional full dataset run when seed entities exist
    full_cases = Path("scripts") / "evaluation_cases.json"
    full_report: Dict[str, Any] | None = None
    if full_cases.exists():
        runner = EvaluationRunner(full_cases, limit=5, k_values=(5, 10))

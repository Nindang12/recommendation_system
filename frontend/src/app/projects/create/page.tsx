...
const projectSections: FormSection[] = [
  {
    ...
    description: "Thong tin nay anh huong truc tiep den matching voi expert, enterprise va funder.",
    fields: [
      {
        ...
        kind: "array",
        itemLabel: "Ky nang",
        description: "Danh sach ky nang/phuong phap ma project can. Nen dung ten ro rang de KG map tot hon.",
        fields: [
          { key: "name", label: "Ten ky nang", placeholder: "Vi du: Python, PyTorch, Computer Vision" },
          { key: "category", label: "Nhom", placeholder: "Programming, Framework, Method, Domain" },
      ...
      },
      {
        ...
        kind: "number",
        description: "TRL 1-9 cua project hien tai.",
        placeholder: "4",
      },
      { key: "requirements_and_timeline.budget.amount", label: "Ngan sach", kind: "number", placeholder: "100000" },
      {
      ...
      },
      {
        ...
        label: "San pham ban giao",
        kind: "array",
        itemLabel: "Deliverable",
        fields: [{ key: "value", label: "Noi dung", placeholder: "Source code, report, patent, API..." }],
      },
      { key: "requirements_and_timeline.timeline.start_date", label: "Ngay bat dau", kind: "date" },
      { key: "requirements_and_timeline.timeline.end_date", label: "Ngay ket thuc", kind: "date" },
      {
        key: "requirements_and_timeline.collaboration_needs.expert_roles_needed",
        label: "Vai tro expert can tim",
        kind: "array",
        itemLabel: "Vai tro",
        fields: [{ key: "value", label: "Vai tro", placeholder: "Clinical Data Annotator, Industrial Data Engineer..." }],
      },
      {
        key: "requirements_and_timeline.collaboration_needs.enterprise_partner_type",
        label: "Loai enterprise partner",
  ...
  {
    title: "R&D profile",
    description: "Mo ta dau ra, dataset, tien do TRL, khoang cach cong nghe va tac dong.",
    fields: [
      {
        ...
        itemLabel: "Output",
        fields: [
          { key: "type", label: "Loai", kind: "select", options: outputTypeOptions },
          { key: "title", label: "Tieu de" },
          { key: "year", label: "Nam", kind: "number" },
          { key: "id", label: "ID san pham/dataset/paper" },
        ],
      },
      {
        key: "rd_profile.required_dataset_ids",
        label: "Dataset can thiet",
        kind: "array",
        itemLabel: "Dataset",
      ...
      { key: "rd_profile.technology_gap.current_trl", label: "TRL hien tai", kind: "number" },
      { key: "rd_profile.technology_gap.target_trl", label: "TRL muc tieu", kind: "number" },
      {
        key: "rd_profile.technology_gap.gap_description",
        label: "Mo ta khoang cach cong nghe",
        kind: "textarea",
        span: "full",
      },
      { key: "rd_profile.impact_and_sustainability.impact_metrics.papers_count", label: "So bai bao", kind: "number" },
      { key: "rd_profile.impact_and_sustainability.impact_metrics.patents_count", label: "So bang sang che", kind: "number" },
      {
        key: "rd_profile.impact_and_sustainability.impact_metrics.commercialization_revenue",
        label: "Doanh thu thuong mai hoa",
        kind: "number",
      },
      {
        key: "rd_profile.impact_and_sustainability.sustainability_metrics",
        label: "Chi so tac dong/ben vung",
        kind: "textarea",
        span: "full",
      },
    ],
  ...
  {
    title: "Relations",
    description: "Cac lien ket nghiep vu giup Neo4j tao path giai thich ro hon.",
    fields: [
      {
        ...
        fields: [
          ...
          { key: "role", label: "Vai tro", placeholder: "PI, Co-PI, Advisor" },
          { key: "period", label: "Thoi gian", placeholder: "2024-2026" },
        ],
      },
      {
        ...
        fields: [
          ...
          { key: "type", label: "Loai hop tac", placeholder: "Industry Partner" },
        ],
      },
      {
      ...
      },
      {
        ...
        label: "Nganh muc tieu",
        kind: "array",
        itemLabel: "Industry",
        fields: [
          { key: "code", label: "Ma nganh", placeholder: "HEAL, MFG, EDU" },
          { key: "name", label: "Ten nganh", placeholder: "Healthcare Technology" },
        ],
      },
      {
        key: "relations.related_projects",
        label: "Project lien quan",
        kind: "array",
        itemLabel: "Project",
  ...
  },
  {
    ...
    description: "Thong tin mo rong cho giai doan sau, spin-off va scale-up.",
    fields: [
      { key: "follow_up_opportunities.next_phase_project_id", label: "Next phase project ID" },
      {
        ...
        label: "Tiem nang spin-off",
        kind: "textarea",
        span: "full",
      },
      { key: "follow_up_opportunities.scale_up_plan", label: "Ke hoach scale-up", kind: "textarea", span: "full" },
    ],
  },
  {
    title: "Governance",
    description: "Quyen rieng tu va do moi cua du lieu. Cac field nay giup admin kiem soat chat luong data.",
    fields: [
      { key: "governance.privacy.privacy_level", label: "Privacy level", kind: "select", options: privacyOptions },
      { key: "governance.privacy.field_privacy.requirements_and_timeline.budget", label: "Privacy cua budget", kind: "select", options: privacyOptions },
      {
      ...
      { key: "governance.temporal_freshness.last_update", label: "Ngay cap nhat gan nhat", kind: "date" },
      { key: "governance.temporal_freshness.update_source", label: "Nguon cap nhat", placeholder: "User_Profile, Project_Lead..." },
          ...
          <div className="space-y-3">
            {items.length === 0 ? (
              <div className="rounded-xl border border-dashed bg-muted/30 p-4 text-sm text-muted-foreground">
                Chua co du lieu. Bam "Them muc" de nhap {field.label.toLowerCase()}.
              </div>
            ) : (
      ...
      <main className="mx-auto max-w-7xl px-4 py-8">
        <div className="mb-7 rounded-3xl border bg-white p-6 shadow-sm">
          <Badge variant="outline" className="rounded-full">
            ...
            Project schema tu seed_data.txt
          </Badge>
          <h1 className="mt-4 text-3xl font-bold tracking-tight">Tao project moi</h1>
          <p className="mt-2 max-w-3xl text-muted-foreground">
            Form nay cho phep nhap cac nhom thong tin day du nhu du lieu mau: basic_info, requirements, R&D profile,
            relations, follow-up opportunities va governance. Khong bat buoc nhap het, nhung cac truong topic/skill/TRL
            se giup recommendation tot hon.
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <section className="rounded-3xl border bg-white p-6 shadow-sm">
            <div className="mb-5">
              ...
              <p className="text-sm text-muted-foreground">Thong tin chinh de frontend, MongoDB va KG nhan dien project.</p>
            </div>
            <div className="grid gap-5 md:grid-cols-2">
              <div className="space-y-2 md:col-span-2">
                <Label>Ten project</Label>
              ...
              <div className="space-y-2">
                ...
                <p className="text-xs text-muted-foreground">Cach nhau bang dau phay.</p>
              </div>
              <div className="space-y-2">
                <Label>Country</Label>
                <Select
              ...
              <div className="space-y-2 md:col-span-2">
                <Label>Quan / huyen / thanh pho</Label>
              ...
              <div className="space-y-3 md:col-span-2">
                <div>
                  ...
                  <p className="mt-1 text-xs text-muted-foreground">
                    He thong tu suy ra research_directions tu topic da chon:{" "}
                    {selectedDirections.length ? selectedDirections.map(researchDirectionLabel).join(", ") : "chua chon"}
                  </p>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-xs text-muted-foreground">Chu de khac duoc luu voi parent_direction = Custom de admin map vao taxonomy sau.</p>
                </div>
              </div>
            </div>
          </section>

...
function formatMetric(value: number | null) {
  return value === null || value === undefined ? "Chua co" : value.toFixed(3);
}
...
export default function EvaluationPage() {
  ...
  useEffect(() => {
    api
      ...
      .catch((requestError) => setError(requestError instanceof Error ? requestError.message : "Khong tai duoc evaluation"))
      ...
      <main className="mx-auto flex max-w-7xl flex-col gap-5 px-4 py-6">
        <div>
          ...
          <p className="mt-2 text-muted-foreground">
            Trang nay la MVP summary. Pipeline metric day du van can lam trong `backend/evaluation/`.
          </p>
        </div>

...
from utils.skill_identity_utils import dedupe_skill_names
...
class RegisterRequest(BaseModel):
    ...
    @field_validator("skills", "custom_skills", mode="before")
    @classmethod
    def normalize_skill_inputs(cls, value: Any) -> List[str]:
        if value is None:
            return []
        return dedupe_skill_names(value)
...
class ProfileUpdateRequest(BaseModel):
    ...
    @field_validator("skills", "custom_skills", mode="before")
    @classmethod
    def normalize_skill_inputs(cls, value: Any) -> Any:
        if value is None:
            return value
        return dedupe_skill_names(value)

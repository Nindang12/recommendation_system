...
class EvaluationRunner:
    ...
    def load_cases(self) -> List[Dict[str, Any]]:
        payload = json.loads(self.cases_path.read_text(encoding="utf-8-sig"))
            ...
            for method in self.methods:
                try:
                    items, latency_ms = await self.rankers.rank(
                        ...
                        heldout_relevant_ids=prepared.get("heldout_relevant_ids") or [],
                    )
                ...
                row: Dict[str, Any] = {
                    ...
                    "evaluation_protocol": prepared.get("evaluation_protocol"),
    ...
    def _prepare_case(self, case: Dict[str, Any]) -> Optional[Dict[str, Any]]:
        ...
        return {
            ...
            "heldout_relevant_ids": relevant_ids
            if case.get("evaluation_protocol") == "leave_one_edge_out"
            else [],
